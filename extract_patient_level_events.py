...
class PatientLevelEventExtractor:
    ...
    def start_extraction(self):
        admissions = pd.read_csv(self.ADMISSIONS_CSV, usecols=["subject_id", "hadm_id", "admittime", "dischtime"])
        ...
        meds = pd.read_csv(self.EMAR_CSV, usecols=["subject_id", "charttime", "medication"])

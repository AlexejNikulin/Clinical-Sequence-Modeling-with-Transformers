...
class PatientLevelEventExtractor:
    ...
    def start_extraction(self):
        admissions = pd.read_csv(self.ADMISSIONS_CSV, usecols=["subject_id", "hadm_id", "admittime", "dischtime", "admission_type"])
        ...
        meds_detail = pd.read_csv(self.EMAR_DETAIL_CSV, usecols=["emar_id", "pharmacy_id", "dose_given", "dose_given_unit"])
        meds_detail = (
